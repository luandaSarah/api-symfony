...
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_USERNAME', fields: ['username'])] //contrainte d'unicité en bdd
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['users:index', 'articles:index', 'articles:show'])] //on peut assi le mettre sur une methode getter, ca sera renvoyer en format json aussi 
